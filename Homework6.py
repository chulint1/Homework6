...
st.title('K-Means Classification')
iter = st.slider('Choose the number of iterations', 1, 10, 5)
st.write("You choose ", iter, 'iterations')
...
kmeans = KMeans(n_clusters = 5, max_iter=iter, init=starting_points, n_init = 1)
kmeans.fit(X);
